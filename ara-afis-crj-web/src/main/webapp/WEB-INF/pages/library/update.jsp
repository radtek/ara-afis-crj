    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active"><i class="icon-pencil"></i>更新指纹库别</li>
            </ul>
            <!--breadcrumbs end -->
        </div>
    </div>
                    ...
                    <div class="form text-nowrap">
                        <form class="cmxform form-horizontal tasi-form" id="dataForm" name="dataForm"
                            ...
                            <input type="hidden" id="anyId" name="anyId"
                                   value="<s:choose><s:when test="${tasLibrary != null}">${tasLibrary.libraryId}</s:when><s:otherwise>0</s:otherwise></s:choose>"/>
                            <div class="form-group ">
                                <label for="libraryId" class="control-label col-lg-1"><span class="form-req">*</span>指纹库ID ：</label>
                                <div class="col-lg-4">
                                    <input id="libraryId" name="libraryId" class="form-control" value="${tasLibrary.libraryId}" readonly
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-4">
                                    <input id="verifyLibraryGoal" name="verifyLibraryGoal" class="form-control"
                                           type="text" value="${tasLibrary.verifyLibraryGoal}"
                            ...
                            <div class="form-group ">
                                <label for="identifyLibraryGoal" class="control-label col-lg-1"><span class="form-req">*</span>1:N比对阈值 ：</label>
                                <div class="col-lg-4">
                                    <input id="identifyLibraryGoal" name="identifyLibraryGoal" class="form-control"
                                           type="text" value="${tasLibrary.identifyLibraryGoal}"
                                           data-rule-onlyNum0_1000="true"
                                           data-msg-onlyNum0_1000="非有效的数字，只能包含：0-1000数字">
                                </div>
                            </div>
                            ...
                            <div class="form-group ">
                                <label for="libraryDesc" class="control-label col-lg-1"><span class="form-req">*</span>指纹库描述 ：</label>
                                <div class="col-lg-4">
                                    <input id="libraryDesc" name="libraryDesc"
                                           value="${tasLibrary.libraryDesc}" class="form-control"
                                           type="text">
                                </div>
                            </div>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-11">
                                    <div class="switch" data-on="success" data-off="danger" data-on-label="可用"
                                         data-off-label="停用">
                                        <input type="checkbox" id="libraryActivietyFlag" name="libraryActivietyFlag"
                                               <s:if test="${tasLibrary.libraryActivietyFlag == 'Y'}">checked</s:if> />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
